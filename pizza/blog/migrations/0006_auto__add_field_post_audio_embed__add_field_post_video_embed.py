...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_post', 'audio_embed',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.video_embed'
        db.add_column('blog_post', 'video_embed',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.audio_embed'
        db.delete_column('blog_post', 'audio_embed')

        # Deleting field 'Post.video_embed'
        db.delete_column('blog_post', 'video_embed')
