...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Blurb'
        db.create_table('kitchen_sink_blurb', (
        ...
        db.send_create_signal('kitchen_sink', ['Blurb'])
        ...
        db.create_table('kitchen_sink_imageset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('captype', self.gf('django.db.models.fields.CharField')(default='override', max_length=10)),
        ))
        db.send_create_signal('kitchen_sink', ['ImageSet'])

        # Adding model 'ImageSetItem'
        db.create_table('kitchen_sink_imagesetitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('kitchen_sink', ['ImageSetItem'])

        # Adding model 'Author'
        db.create_table('kitchen_sink_author', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('kitchen_sink', ['Author'])

        # Adding M2M table for field sites on 'Author'
        m2m_table_name = db.shorten_name('kitchen_sink_author_sites')
        ...
        m2m_table_name = db.shorten_name('kitchen_sink_page_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        m2m_table_name = db.shorten_name('kitchen_sink_redirect_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('kitchen_sink_blurb')
        ...
        db.delete_table('kitchen_sink_imageset')

        # Deleting model 'ImageSetItem'
        db.delete_table('kitchen_sink_imagesetitem')

        # Deleting model 'Author'
        db.delete_table('kitchen_sink_author')

        # Removing M2M table for field sites on 'Author'
        db.delete_table(db.shorten_name('kitchen_sink_author_sites'))

        # Deleting model 'Page'
        db.delete_table('kitchen_sink_page')

        # Removing M2M table for field sites on 'Page'
        db.delete_table(db.shorten_name('kitchen_sink_page_sites'))

        # Deleting model 'Redirect'
        db.delete_table('kitchen_sink_redirect')

        # Removing M2M table for field sites on 'Redirect'
        db.delete_table(db.shorten_name('kitchen_sink_redirect_sites'))
