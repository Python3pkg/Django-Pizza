...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inline.icnt'
        db.add_column('kitchen_sink_inline', 'icnt',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inline.icnt'
        db.delete_column('kitchen_sink_inline', 'icnt')
    ...
    models = {
        ...
        'kitchen_sink.inline': {
            ...
            'icnt': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
